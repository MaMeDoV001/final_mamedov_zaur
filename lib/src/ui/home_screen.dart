...
import 'package:movie_db_app/src/ui/settings_screen.dart';
...
class HomeScreen extends State<HomeScreenMain>{
  ...
  Widget build(BuildContext context) {
    var navBar = SalomonBottomBar(

      unselectedItemColor: Color.fromARGB(100, 118, 107, 130),
      ...
      items: [
        ...
        SalomonBottomBarItem(
          ...
          title: Text("Search", style: TextStyle(fontFamily: "muli")),
          selectedColor: Colors.pink,
        ),
        SalomonBottomBarItem(
          icon: Icon(Icons.newspaper),
          title: Text("News", style: TextStyle(fontFamily: "muli"),),
          selectedColor: Colors.blue,
        ),
        SalomonBottomBarItem(
          icon: Icon(Icons.settings),
          title: Text("Settings", style: TextStyle(fontFamily: "muli"),),
          selectedColor: Colors.green,
        ),
      ],
      currentIndex: sectionIndex,
      onTap: (i) => setState(() => sectionIndex = i),
    );
    ...
    return MultiBlocProvider(
      ...
      child: Scaffold(
        ...
        body: sectionIndex == 0 ? _buildBody(context) : navBarItemChose(sectionIndex),
